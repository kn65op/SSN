...
${OBJECTDIR}/nic.o: nic.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/nic.o nic.cpp
...
${TESTDIR}/tests/NeuronTest.o: tests/NeuronTest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/NeuronTest.o tests/NeuronTest.cpp
...
${OBJECTDIR}/nic_nomain.o: ${OBJECTDIR}/nic.o nic.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/nic_nomain.o nic.cpp;\
	else  \
