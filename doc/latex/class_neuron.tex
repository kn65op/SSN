...
\-Funkcja ucząca wg reguły delta. \-Stosowana tylko dla sieci jednowarstwowych i warstwy wyjściowej sieci wielowarstwowej. \-Wymaga odpowiedź jest pobierana z elementu następnego, z którym neuron jest połączony klasą \hyperlink{class_link}{\-Link}. \hypertarget{class_neuron_a6471332d3b91b31988c861b96b23ddf1}{\index{\-Neuron@{\-Neuron}!load\-From\-File@{load\-From\-File}}
\index{load\-From\-File@{load\-From\-File}!Neuron@{\-Neuron}}
\subsubsection[{load\-From\-File}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T , class Activation\-Function  = \-Step\-Activation\-Function$<$\-T$>$()$>$ void {\bf \-Neuron}$<$ \-T, {\bf \-Activation\-Function} $>$\-::{\bf load\-From\-File} (
\begin{DoxyParamCaption}
\item[{std\-::ifstream \&}]{file}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{class_neuron_a6471332d3b91b31988c861b96b23ddf1}
\-Wczytanie wag neuronu z pliku. 
\begin{DoxyParams}{\-Parameters}
{\em file} & \-Plik jako std\-::ifstream, z którego czytamy. \\
\hline
\end{DoxyParams}
\hypertarget{class_neuron_ac112e85f169835dad11a6f7bd9e477b9}{\index{\-Neuron@{\-Neuron}!print\-Wages@{print\-Wages}}
...
\-Funkcja propagująca błąd do głębszych warstw sieci. \hypertarget{class_neuron_a335b33e8c65ce8975472ff577a12dce5}{\index{\-Neuron@{\-Neuron}!save\-To\-File@{save\-To\-File}}
\index{save\-To\-File@{save\-To\-File}!Neuron@{\-Neuron}}
\subsubsection[{save\-To\-File}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T , class Activation\-Function  = \-Step\-Activation\-Function$<$\-T$>$()$>$ void {\bf \-Neuron}$<$ \-T, {\bf \-Activation\-Function} $>$\-::{\bf save\-To\-File} (
\begin{DoxyParamCaption}
\item[{std\-::ofstream \&}]{file}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{class_neuron_a335b33e8c65ce8975472ff577a12dce5}
\-Zapis wag neuronu do pliku. 
\begin{DoxyParams}{\-Parameters}
{\em file} & \-Plik jako std\-::ofstream, do którego zapisujemy. \\
\hline
\end{DoxyParams}
\hypertarget{class_neuron_a1a20d9ac9bf64126f8d74d8c1c7d3c58}{\index{\-Neuron@{\-Neuron}!set\-Link\-In@{set\-Link\-In}}
