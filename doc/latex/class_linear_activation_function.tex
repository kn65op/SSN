...
\hypertarget{class_linear_activation_function_aed111abd3fbc37e8a0faff788258a97d}{\index{\-Linear\-Activation\-Function@{\-Linear\-Activation\-Function}!deriterative@{deriterative}}
\index{deriterative@{deriterative}!LinearActivationFunction@{\-Linear\-Activation\-Function}}
\subsubsection[{deriterative}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ \-T {\bf \-Linear\-Activation\-Function}$<$ \-T $>$\-::{\bf deriterative} (
\begin{DoxyParamCaption}
\item[{\-T}]{x}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inline\mbox{]}}}}\label{class_linear_activation_function_aed111abd3fbc37e8a0faff788258a97d}
\-Funkcja licząca pochodną 
\begin{DoxyParams}{\-Parameters}
{\em x} & \-Wartość dla której liczymy pochodną. \\
\hline
\end{DoxyParams}
